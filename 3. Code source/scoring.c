...
{
    //on test si l'arbitre a appuyé sur 1 ou 2
if (joueur_gagnant=='1'|| joueur_gagnant=='2')
{
   ...
   if (joueur_gagnant=='1')
	...
	return 0;
	//Ici on informe que tout c'est bien passé
	*pointeur_test=0;
}
    /*Parcontre si l'arbitre a appuyé sur une autre touche que 1 ou 2
    on renvoie un message d'erreur et on ne traite pas le score */
